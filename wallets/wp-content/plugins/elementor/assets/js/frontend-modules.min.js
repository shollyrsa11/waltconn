    ...
    [354], {
        ...
        806: (e, t, r) => {
            ...
            class BaseNestedTabs extends i.default {
                ...
                activateTab(e) {
                    const t = this.getSettings(),
                        r = t.classes.active,
                        n = this.elements.$tabTitles.filter(this.getTabTitleFilterSelector(e)),
                        i = this.elements.$tabContents.filter(this.getTabContentFilterSelector(e)),
                        o = "show" === t.showTabFn ? 0 : 400;
                    n.add(i).addClass(r), n.attr({
                        tabindex: "0",
                        "aria-selected": "true",
                        "aria-expanded": "true"
                    }), i[t.showTabFn](o, (() => {
                        elementorFrontend.elements.$window.trigger("elementor-pro/motion-fx/recalc"), elementorFrontend.elements.$window.trigger("elementor/nested-tabs/activate", i)
                    })), i.removeAttr("hidden")
                }
                isActiveTab(e) {
                    ...
                    t += parseInt(this.elements.$container.css("margin-top"), 10), this.elements.$items.each((function(i) {
                        ...
                        if (o) {
                            var c = s.position(),
                                u = i % n,
                                l = c.top - t - e[u];
                            l -= parseInt(s.css("margin-top"), 10), l *= -1, s.css("margin-top", l + "px"), e[u] += a
                        } else e.push(a)
                    }))
                }
            });
            ...
            t.default = class Scroll {
                ...
                static getElementViewportPercentage(e) {
                    ...
                    const r = e[0].getBoundingClientRect(),
                        ...
                        c = 0 - a + o,
                        u = r.top + o + e.height() - a + s,
                        l = Math.max(0, Math.min(c / u, 1));
        ...
        1343: (e, t, r) => {
            ...
            e.exports = function(e, t, r, a) {
                ...
                if (n(r) && o(r, u, a), a.global) c ? e[t] = r : s(t, r);
                else {
                    try {
        ...
        1695: (e, t, r) => {
            ...
            e.exports = function(e, t) {
                ...
                if (r = g ? n : m ? n[h] || a(h, {}) : (n[h] || {}).prototype)
                    for (l in t) {
                        if (d = t[l], f = e.dontCallGetSet ? (p = i(r, l)) && p.value : r[l], !u(g ? l : h + (m ? "." : "#") + l, e.forced) && void 0 !== f) {
                            if (typeof d == typeof f) continue;
                            c(d, f)
                        }(e.sham || f && f.sham) && o(d, "sham", !0), s(r, l, d, e)
                    }
            }
        },
        3677: e => {
        ...
        1352: (e, t, r) => {
            ...
            e.exports = function(e, t) {
                ...
                for (; t.length > u;) i(n, r = t[u++]) && (~s(l, r) || c(l, r));
                return l
            }
        },
        7446: (e, t) => {
                    ...
                    var T = n("Error"),
                        I = t((function(e, t) {
                            var r = f(v ? t : e, void 0),
                                n = v ? new x(e) : new x;
                            return void 0 !== r && o(n, "message", r), h && o(n, "stack", p(n.stack, 2)), this && s(E, this) && l(n, this, I), arguments.length > b && d(n, arguments[b]), n
                        }));
                    if (I.prototype = E, "Error" !== w ? a ? a(I, T) : c(I, T, {
                            name: !0
                        }) : g && y in x && (u(I, x, y), u(I, x, "prepareStackTrace")), c(I, x), !m) try {
